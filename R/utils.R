#' Retrieve the 'pag' key to acces INFCcatalog
#'
#' This function resolves species EPPOcodes retriving the 'pag' value, the page number
#' in the original publication, used as a key by the package to archive estimation
