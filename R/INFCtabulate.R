...
#' @return
#'  Function principal output is the printout of the volume or pythomass tables.
#'  If print_tab = FALSE, the function will only returns a tibble with a list column
#'  containing the tabulation of the required estimation equation/s.
#'  Using default values, tables will be identical to the corresponding published
#'  ones (or anyway similar to it) with white cells delimiting the domain of
